...
import (
	...
	models "github.com/miceremwirigi/go-fiber-postgres/models/books"
	"github.com/miceremwirigi/go-fiber-postgres/storage"
	"gorm.io/gorm"
)
...
func (r *Repository) DeleteBook(context *fiber.Ctx) error {
	...
	context.Status(http.StatusOK).JSON(
		&fiber.Map{"message": "book deleted succesfully"})
	return nil
}
